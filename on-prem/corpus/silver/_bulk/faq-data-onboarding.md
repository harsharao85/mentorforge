---
source: {system: kb, instance: northstar-kb, source_id: "FAQ_DATA_ONBOARDING", connector_version: "1.0"}
...
content_meta: {type: kb, title: "FAQ — Data Onboarding", tags: [data, faq, onboarding]}
---

# Frequently Asked Questions — Data at Northstar
...
**Q: What tooling does Northstar use for data engagements?**
A: The Data practice uses a standardized stack documented in the Data Practice Playbook.
