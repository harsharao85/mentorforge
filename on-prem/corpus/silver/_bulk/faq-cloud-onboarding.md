---
source: {system: kb, instance: northstar-kb, source_id: "FAQ_CLOUD_ONBOARDING", connector_version: "1.0"}
...
content_meta: {type: kb, title: "FAQ — Cloud Onboarding", tags: [cloud, faq, onboarding]}
---

# Frequently Asked Questions — Cloud at Northstar
...
**Q: What tooling does Northstar use for cloud engagements?**
A: The Cloud practice uses a standardized stack documented in the Cloud Practice Playbook.
